...
From `backend\`: `.\.venv\Scripts\python.exe -m pytest -q`  (146 passing: health, approval gate +
...
the alert→research loop (opt-in flag, hourly cap, approval-gate parity), and sizing bands)
